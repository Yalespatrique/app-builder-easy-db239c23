...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Painel de teste do reprodutor Asterplay para ativação de listas." },
      { name: "author", content: "Asterplay" },
      { property: "og:title", content: "Asterplay Android TV" },
      { property: "og:description", content: "Painel de ativação e cadastro de DNS do reprodutor Asterplay." },
